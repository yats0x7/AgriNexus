...
const navigationItems = [
  ...
  {
    title: "Expert Advice",
    url: createPageUrl("ExpertAdvice"),
    icon: Users,
    color: "text-purple-600"
  },
  {
    title: "Field Visit",
    url: createPageUrl("FieldVisit"),
    icon: UserCheck,
    color: "text-teal-600"
  },
  {
    title: "Government Schemes",
    url: createPageUrl("GovernmentSchemes"),
    icon: FileText,
    color: "text-orange-600"
  },
  {
    title: "Seeds & Crops",
    url: createPageUrl("SeedsMarketplace"),
    icon: Sprout,
    color: "text-lime-600"
  },
  {
    title: "Seed Recommendations",
    url: createPageUrl("SeedsRecommendations"),
    icon: Brain,
    color: "text-indigo-600"
  },
  {
    title: "Fertilizer Guide",
    url: createPageUrl("FertilizerGuide"),
    icon: FlaskConical,
    color: "text-amber-600"
  },
  {
    title: "Crop Calendar",
    url: createPageUrl("CropCalendar"),
    icon: Calendar,
    color: "text-pink-600"
  }
];
                ...
                <SidebarMenu className="space-y-1">
                  {navigationItems.map((item) => (
                    <SidebarMenuItem key={item.title}>
                      <SidebarMenuButton 
                        asChild 
                        className={`group hover:bg-green-50 hover:text-green-700 transition-all duration-200 rounded-xl px-4 py-3 ${
