...
import { MandiPrice, MandiPriceInterface } from '@/entities/MandiPrice';
import { z } from 'zod';

// Use MandiPriceInterface for consistency
type PriceData = MandiPriceInterface;
...
export default function MandiPrices() {
    ...
    const generateAiInsights = React.useCallback(async () => {
        ...
        try {
            ...
            const insights = JSON.parse(responseStr);
                            ...
                            <div style={{ width: '100%', height: 300 }}>
                                <ResponsiveContainer>
                                    <LineChart data={historicalData}>
                                        ...
                                        <Tooltip
                                            formatter={(value: number | string) => [`₹${Math.round(Number(value))}`, 'Price/Qtl']}
                                        />
                                        <Legend />
                                        <Line
                                            type="monotone"
